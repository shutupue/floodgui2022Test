while wait() do
    ...
    local Map = Multi:WaitForChild('Map', 9e6)
    local mapName = if Map:WaitForChild('Settings'):FindFirstChild("MapName") then Map:WaitForChild('Settings'):FindFirstChild("MapName").Value else Map:WaitForChild('Settings'):GetAttribute("MapName")
    print(mapName)
